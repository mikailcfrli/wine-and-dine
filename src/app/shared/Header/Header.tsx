...
<div className="for-background">
        <div className="container">
            <div className="wines">
                <a href="#" className="wine">Wine</a>
                <a href="#" className="wine">Sparkling</a>
                <a href="#" className="wine">Whiskey</a>
                <a href="#" className="wine">Cognac</a>
                <a href="#" className="wine">Armagnac</a>
                <a href="#" className="wine">Rom</a>
                <a href="#" className="wine">Vodka</a>
                <a href="#" className="wine">Liqueur</a>
                <a href="#" className="wine">Cocktails</a>
                <a href="#" className="wine">Delicacy</a>
            </div>
                ...
                <div className="for-2writes">
                        ...
                        <div className="second-div">
                            <div className="for-image">
                                <img src={specialwrite} className="special-write" /></div>
                                
                            <p className="background-p">PICHON LONGUEVILLE<br/> COSMETESSE DE LALANDE </p>
                            <a href="#" className="for-order">ORDER WINE</a>
            ...
            <div className="for-picturesss">
                <button className="for-foto1">
                    <div className="div-for-foto">
                        <p className="p1-for-foto1">ON THE TERRITORY OF BORDEAUX</p>
                        <p className="p2-for-foto1">WINE BRANDING</p>
                    </div>
                </button>
                <button className="for-foto2">
                    <div className="div-for-foto">
                        <p className="p1-for-foto2">WHAT MAKES US SPECIAL?</p>
                        <p className="p2-for-foto2">INTERVIEW WITH A SOMMELIE</p>
                    </div>
                </button>
                <button className="for-foto3">
                    <div className="div-for-foto">
                        <p className="p1-for-foto3">WITH INTERESTING INGREDIENTS</p>
                        <p className="p2-for-foto3">SIGNATURE COCKTAILS</p>
                    </div>
                </button>
            </div>
        </div>
