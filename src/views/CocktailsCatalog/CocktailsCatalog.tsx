  ...
  const products = [
    {
      ...
      image: './assets/products/cocktail1.png',
      year: 2009,
      size: 0.75,
      country: 'FRANCE',
    ...
    },
    {
      ...
      title: 'LES GREFFIEUX',
      flag: '/assets/products/flag-france.png',
      image: '/assets/products/cocktail2.png',
      year: 2009,
      size: 0.75,
      country: 'FRANCE',
      factory: 'M.CHAPOUTIER',
    },
    {
      ...
      flag: '/assets/products/flag-france.png',
      image: '/assets/products/cocktail3.png',
      year: 2009,
      size: 0.75,
      country: 'FRANCE',
      factory: 'M.CHAPOUTIER',
    },
    {
      ...
      title: 'L’ERMITE HERMITAGE',
      flag: '/assets/products/flag-france.png',
      image: './assets/products/cocktail4.png',
      year: 2009,
      size: 0.75,
      country: 'FRANCE',
      factory: 'M.CHAPOUTIER',
